...
Original file is located at
    https://colab.research.google.com/drive/1-IYeG18PZ231XJXqzEcYMS7cBj2AIT4f
"""
...
def refine_json(text_input: str, case_style: str = "snake_case", remove_nulls: bool = False,
    ...
    try:
        # Modified line
        case_enum = CaseStyle[JSONRefinerCore.to_snake_case(case_style).upper()]
...
def convert_case(json_text: str, target_case: str) -> Tuple[str, str]:
    ...
    try:
        data = json.loads(json_text)
        # Modified line
        case_enum = CaseStyle[JSONRefinerCore.to_snake_case(target_case).upper()]
